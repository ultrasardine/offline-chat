...
class TestAgentConnectionAssignmentInitialization:
    ...
    def test_create_with_read_only_access(self):
        ...
        assignment = AgentConnectionAssignment(connection_name="prod-db", access_level=AccessLevel.READ_ONLY)
    ...
    def test_create_with_read_write_access(self):
        ...
        assignment = AgentConnectionAssignment(connection_name="dev-db", access_level=AccessLevel.READ_WRITE)
    ...
    def test_create_with_empty_allowed_tables(self):
        ...
        assignment = AgentConnectionAssignment(
            connection_name="test-db", access_level=AccessLevel.TABLE_SPECIFIC_READ, allowed_tables=[]
        )
...
class TestAgentConnectionAssignmentSerialization:
    ...
    def test_to_dict_read_only(self):
        ...
        assert result == {"connection_name": "prod-db", "access_level": "read-only", "allowed_tables": None}
    ...
    def test_to_dict_read_write(self):
        ...
        assert result == {"connection_name": "dev-db", "access_level": "read-write", "allowed_tables": None}
    ...
    def test_to_dict_empty_allowed_tables(self):
        ...
        assert result == {"connection_name": "test-db", "access_level": "table-specific-read", "allowed_tables": []}

    def test_to_dict_preserves_access_level_enum_value(self):
        """Test that to_dict converts AccessLevel enum to its string value."""
        assignment = AgentConnectionAssignment(connection_name="test-db", access_level=AccessLevel.READ_ONLY)
...
class TestAgentConnectionAssignmentDeserialization:
    ...
    def test_from_dict_read_only(self):
        ...
        data = {"connection_name": "prod-db", "access_level": "read-only", "allowed_tables": None}
    ...
    def test_from_dict_read_write(self):
        ...
        data = {"connection_name": "dev-db", "access_level": "read-write", "allowed_tables": None}
    ...
    def test_from_dict_without_allowed_tables_key(self):
        ...
        data = {"connection_name": "test-db", "access_level": "read-only"}
    ...
    def test_from_dict_empty_allowed_tables(self):
        ...
        data = {"connection_name": "test-db", "access_level": "table-specific-read", "allowed_tables": []}
    ...
    def test_from_dict_missing_connection_name(self):
        ...
        data = {"access_level": "read-only", "allowed_tables": None}
    ...
    def test_from_dict_missing_access_level(self):
        ...
        data = {"connection_name": "test-db", "allowed_tables": None}
    ...
    def test_from_dict_invalid_access_level(self):
        ...
        data = {"connection_name": "test-db", "access_level": "invalid-level", "allowed_tables": None}
...
class TestAgentConnectionAssignmentRoundTrip:
    ...
    def test_round_trip_read_only(self):
        ...
        original = AgentConnectionAssignment(connection_name="prod-db", access_level=AccessLevel.READ_ONLY)
...
class TestAgentConnectionAssignmentEdgeCases:
    ...
    def test_connection_name_with_special_characters(self):
        ...
        assignment = AgentConnectionAssignment(connection_name="prod-db-123", access_level=AccessLevel.READ_ONLY)
    ...
    def test_many_allowed_tables(self):
        ...
        assignment = AgentConnectionAssignment(
            connection_name="test-db", access_level=AccessLevel.TABLE_SPECIFIC_READ, allowed_tables=tables
        )
    ...
    def test_equality_same_values(self):
        ...
        assignment1 = AgentConnectionAssignment(connection_name="test-db", access_level=AccessLevel.READ_ONLY)
        assignment2 = AgentConnectionAssignment(connection_name="test-db", access_level=AccessLevel.READ_ONLY)
    ...
    def test_equality_different_connection_name(self):
        ...
        assignment1 = AgentConnectionAssignment(connection_name="db1", access_level=AccessLevel.READ_ONLY)
        assignment2 = AgentConnectionAssignment(connection_name="db2", access_level=AccessLevel.READ_ONLY)
    ...
    def test_equality_different_access_level(self):
        ...
        assignment1 = AgentConnectionAssignment(connection_name="test-db", access_level=AccessLevel.READ_ONLY)
        assignment2 = AgentConnectionAssignment(connection_name="test-db", access_level=AccessLevel.READ_WRITE)
    ...
    def test_equality_different_allowed_tables(self):
        ...
        assignment1 = AgentConnectionAssignment(
            connection_name="test-db", access_level=AccessLevel.TABLE_SPECIFIC_READ, allowed_tables=["users"]
        )
        assignment2 = AgentConnectionAssignment(
            connection_name="test-db", access_level=AccessLevel.TABLE_SPECIFIC_READ, allowed_tables=["orders"]
        )
