...
@given(
    db_type=st.sampled_from(["oracle", "postgresql", "mysql", "sqlite", None])
)
...
def test_property_find_query_tool_returns_valid_or_none(tool_names):
    ...
    **Property: Query tool discovery correctness**
    ...
    if result is not None:
        ...
        assert result in tool_names, \
            f"Found tool '{result}' should exist in input tool names"
