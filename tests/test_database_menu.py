...
from offline_chat.database.result import Ok, Err, is_ok, is_err, unwrap
...
class TestCreateConnectionFlow:
    ...
    @patch('builtins.input', side_effect=['test-conn', '1', 'localhost', '1521', 
                                          'TESTDB', 'user'])
    @patch('offline_chat.database_menu.getpass', return_value='pass')
    @patch('builtins.print')
    def test_create_oracle_connection_success(self, mock_print, mock_getpass, 
                                              mock_input, mock_manager):
    ...
    def test_create_duplicate_name_fails(self, mock_getpass, mock_input, mock_manager):
        ...
        with patch('builtins.input', side_effect=['test-conn', '1', 'localhost', 
                                                   '1521', 'TESTDB', 'user']):
...
class TestListConnectionsDisplay:
    ...
    @patch('builtins.print')
    def test_list_displays_oracle_connection(self, mock_print, mock_manager, 
                                             sample_oracle_connection):
    ...
    @patch('builtins.print')
    def test_list_displays_postgres_connection(self, mock_print, mock_manager,
    ...
    @patch('builtins.print')
    def test_list_shows_agents_using_connection(self, mock_print, mock_manager,
                                                sample_oracle_connection, tmp_path):
        ...
        config = {
            ...
            "connection_assignments": [
                {"connection_name": "test-oracle", "access_level": "read-only"}
            ]
        }
...
class TestUpdateConnectionFlow:
    ...
    @patch('builtins.print')
    def test_update_oracle_host(self, mock_print, mock_input, mock_manager,
                                sample_oracle_connection):
    ...
    @patch('builtins.print')
    def test_update_password(self, mock_print, mock_getpass, mock_input,
                            mock_manager, sample_oracle_connection):
    ...
    @patch('builtins.print')
    def test_update_no_changes(self, mock_print, mock_input, mock_manager,
                               sample_oracle_connection):
...
class TestDeleteConnectionFlow:
    ...
    @patch('builtins.input', side_effect=['1', 'y'])
    @patch('builtins.print')
    def test_delete_connection_success(self, mock_print, mock_input, mock_manager,
                                       sample_oracle_connection):
    ...
    @patch('builtins.input', side_effect=['1', 'n'])
    @patch('builtins.print')
    def test_delete_confirmation_declined(self, mock_print, mock_input, mock_manager,
                                         sample_oracle_connection):
    ...
    @patch('builtins.print')
    def test_delete_connection_in_use(self, mock_print, mock_input, mock_manager,
                                      sample_oracle_connection):
...
class TestSelectConnection:
    ...
    @patch('builtins.input', return_value='1')
    def test_select_first_connection(self, mock_input, mock_manager,
                                     sample_oracle_connection):
...
class TestConfigureConnections:
    ...
    @patch('builtins.print')
    def test_configure_oracle_missing_required_fields(self, mock_print, 
                                                      mock_getpass, mock_input):
