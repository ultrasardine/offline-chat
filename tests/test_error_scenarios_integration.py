    ...
    **Validates: Requirements 2.3**
    ...
    async def run_test():
        ...
        with patch("offline_chat.session.MCPClientManager") as MockManager:
            ...
            error_message = "Failed to connect to PostgreSQL database at nonexistent.host.local:5432 - Connection refused"
    ...
    **Validates: Requirements 3.4**
    ...
    async def run_test():
        ...
        sqlite_config = create_database_mcp_config(
            "sqlite", "test_db", path=temp_sqlite_db
        )
